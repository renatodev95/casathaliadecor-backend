...
import com.casathaliadecor.dao.BillDao;
...
public class BillServiceImpl implements BillService {
    ...
    public ResponseEntity<String> generateReport(Map<String, Object> requestMap) {
        ...
        try {
            ...
            if (validateRequestMap(requestMap)) {
                ...
                String data = createDataString(requestMap);
                ...
                Paragraph chunk = new Paragraph("Casa Thália Decorações", getFont("Header"));
                ...
                Paragraph footer = new Paragraph("Total: " + (String) requestMap.get("total") + "\n" +
                        "Agradecemos a preferência!", getFont("Data"));
                document.add(footer);
                document.close();
    ...
    private void addTableHeader(PdfPTable table) {
        ...
        Stream.of("Nome", "Categoria", "Quantidade", "Preço UN", "Preço Total")
                .forEach(columnTitle -> {
